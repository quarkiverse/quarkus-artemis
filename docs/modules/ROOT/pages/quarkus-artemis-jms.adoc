...
| End of Life
a|
`3.36.x`, [.line-through]#`3.35.x`#, [.line-through]#`3.34.x`#
a|
latest `3.14.x`
a|
TBA
...
a|
[.line-through]#2026-03-28#
a|
[.line-through]#`3.31.x`#, [.line-through]#`3.32.x`#
a|
[.line-through]#latest `3.12.x`#
a|
[.line-through]#2026-03-19#
a|
[.line-through]#`3.30.x`#
a|
[.line-through]#latest `3.11.x`#
a|
[.line-through]#2025-02-02#
a|
[.line-through]#`3.28.x`#, [.line-through]#`3.29.x`#
a|
[.line-through]#`3.10.x`#
a|
[.line-through]#2025-11-26#
a|
[.line-through]#`3.15.x`#
a|
...
=== Error reporting of failed health checks

When a health check for a server locator or connection factory fails, then:

* the data for this server locator or connection factory is set to `"DOWN, see error-id <id>"`, and
* a log message in the form of `"Exception occurred during health check of [server locator | connection factory]  <name> (error-id <id>)"`.
The log level of this message can be set through configuration property `quarkus.artemis.health.fail.log-level`.
If not set, `quarkus.artemis.health.fail.log-level` defaults to `INFO`.
The log message also holds a `MDC` entry with key `error-id` and value `<id>`.

.Sample health response on error with `error-id`
[%collapsible]
====
[source,json]
----
    ...
    "checks": [
        {
            ...
            "status": "DOWN",
            "data": {
                "<default>": "DOWN, see error-id ce6bf00c-0024-42b8-803d-0135ea131e06"
            }
        }
    ]
}
...
.Sample log on failing health check
[%collapsible]
====
[source]
----
2025-11-08 11:59:48,056 INFO  [io.qua.art.jms.run.hea.ConnectionFactoryHealthCheck] (vert.x-worker-thread-1) Exception occurred during health check of connection factory <default> (error-id ce6bf00c-0024-42b8-803d-0135ea131e06): jakarta.jms.JMSException: Failed to create session factory
	...
	at org.apache.activemq.artemis.jms.client.ActiveMQConnectionFactory.createXAConnection(ActiveMQConnectionFactory.java:386)
	at org.apache.activemq.artemis.jms.client.ActiveMQConnectionFactory.createXAConnection(ActiveMQConnectionFactory.java:381)
	at org.messaginghub.pooled.jms.JmsPoolXAConnectionFactory.createProviderConnection(JmsPoolXAConnectionFactory.java:85)
	at org.messaginghub.pooled.jms.JmsPoolXAConnectionFactory.createProviderConnection(JmsPoolXAConnectionFactory.java:46)
	at org.messaginghub.pooled.jms.JmsPoolConnectionFactory$1.makeObject(JmsPoolConnectionFactory.java:119)
	at org.messaginghub.pooled.jms.JmsPoolConnectionFactory$1.makeObject(JmsPoolConnectionFactory.java:116)
	at org.apache.commons.pool2.impl.GenericKeyedObjectPool.create(GenericKeyedObjectPool.java:796)
	at org.apache.commons.pool2.impl.GenericKeyedObjectPool.addObject(GenericKeyedObjectPool.java:341)
	at org.messaginghub.pooled.jms.JmsPoolConnectionFactory.createJmsPoolConnection(JmsPoolConnectionFactory.java:773)
	at org.messaginghub.pooled.jms.JmsPoolConnectionFactory.createConnection(JmsPoolConnectionFactory.java:259)
	at org.messaginghub.pooled.jms.JmsPoolConnectionFactory.createConnection(JmsPoolConnectionFactory.java:254)
	at jakarta.jms.ConnectionFactory_tBORokLmr_ADGinSNA0ijl7u0zc_Synthetic_ClientProxy.createConnection(Unknown Source)
	at io.quarkus.artemis.jms.runtime.health.ConnectionFactoryHealthCheck.call(ConnectionFactoryHealthCheck.java:52)
	at io.quarkus.artemis.jms.runtime.health.ConnectionFactoryHealthCheck_ClientProxy.call(Unknown Source)
...
2025-11-08 11:59:48,078 INFO  [io.sma.health] (vert.x-eventloop-thread-1) SRHCK01001: Reporting health down status: {"status":"DOWN","checks":[{"name":"Artemis JMS health check","status":"DOWN","data":{"<default>":"DOWN, see error-id ce6bf00c-0024-42b8-803d-0135ea131e06"}}]}
----
====
