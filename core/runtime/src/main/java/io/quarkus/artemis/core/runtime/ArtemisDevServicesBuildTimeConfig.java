...
public interface ArtemisDevServicesBuildTimeConfig {
    ...
    String DEFAULT_IMAGE = "quay.io/arkmq-org/activemq-artemis-broker:artemis.2.41.0";
     ...
     * <p>
     * Defaults to {@code quay.io/arkmq-org/activemq-artemis-broker:artemis.2.41.0}
     */
